...
class MISPayHelper
{
    ...
    {
        $value = $this->config->getValue('payment/mispaymethod_dynamic_callback/is_widget_enabled', $this->getScopeInterface());
    ...
    {
        $value = $this->config->getValue('payment/mispaymethod_dynamic_callback/min_order_total', $this->getScopeInterface());
    ...
    {
        $value = $this->config->getValue('payment/mispaymethod_dynamic_callback/max_order_total', $this->getScopeInterface());
        return floatval($value);
    }
    ...
    {
        $value = $this->config->getValue('payment/mispaymethod_dynamic_callback/min_widget_limit', $this->getScopeInterface());
        return floatval($value);
    }
    ...
    {
        $value = $this->config->getValue('payment/mispaymethod_dynamic_callback/max_widget_limit', $this->getScopeInterface());
        return floatval($value);
    }
